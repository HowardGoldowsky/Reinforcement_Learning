...
if (learningAlgorithm.trainAgent)
    for episode = 1:gridWorld.numEpisodes
        ...
        for iteration = 1:gridWorld.numIterations
            ...
            % food or enemy.           
            agent = agent.observe(food,gridWorld.lengthGrid,'currentObs');      % returns agent.observation       
            ...
            [learningAlgorithm, agent] = learningAlgorithm.policy(agent);       % returns agent.action and agent.choice
            ...
            agent = agent.observe(food,gridWorld.lengthGrid,'newObs');          % returns agent.newObs 
